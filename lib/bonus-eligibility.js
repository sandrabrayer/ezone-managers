   ...
   For each house the monthly bonus is decided in two parts:
     ...
     1. TIER AMOUNT — a step function of the AVERAGE DAILY occupancy across the
        ...
        the figure meets the WHOLE-NUMBER threshold (18.9 does NOT reach 19).
          ...
          Ramot HaShavim:  17 → 2000, 19 → 2500, 20 → 3000   (below 17 → 0)
          Ra'anana Asher:  10 → 2000, 12 → 2500, 14+ → 3000  (below 10 → 0)
          Efroni:          10 → 2000, 12 → 2500, 13+ → 3000  (below 10 → 0)
          Rehab:           10 → 2000, 12 → 2500, 13+ → 3000  (below 10 → 0)
          Pardes:          10 → 2000, 12 → 2500, 13+ → 3000  (below 10 → 0)
